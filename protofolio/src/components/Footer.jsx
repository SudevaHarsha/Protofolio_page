...
import {FaGithub,FaTwitter,FaLinkedinIn,FaFacebook, FaWhatsapp, FaShare, FaDownload} from "react-icons/fa";
    ...
    <div className="footer">
        <div className="icons_container">
            ...
            <div className={` ${sessionStorage.getItem('myData')!=0 ? "icon_animation" :"icon"}`} onClick={()=>handleShareClick()}>
                <FaShare className='fa' />
            </div>
            <button onClick={handleDownload} className={`signout ${sessionStorage.getItem('myData')!=0 ? "signout_animation" :""}`}>Resume <FaDownload /></button>
        </div>
