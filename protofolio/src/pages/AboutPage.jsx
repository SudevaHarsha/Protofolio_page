          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-center sm:order-2 sm:col-span-8">
              <h2 className="mb-4 text-lg font-bold  text-white">
                <p className='font-medium'>My name is sudeva harsha.i am enthusiatic web developer and UI/Ux designer with a passion of creating beautifull , functional and user-centered design experiences . I always look innovative ways to bring my clients vision to life.<br/><br/>
